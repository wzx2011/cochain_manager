...
public class ResourceController extends BaseController {
     ...
     * 查询所有的资源tree
     */
    @RequestMapping("/allShiroTrees")
    @ResponseBody
    public Object allShiroTrees() {
        ShiroUser shiroUser = getShiroUser();
        return resourceService.selectAllShiroTree(shiroUser);
    }
    ...
    @RequestMapping("/edit")
    @ResponseBody
    public Object edit(@Valid SysResource resource) {
