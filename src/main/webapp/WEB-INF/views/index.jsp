    ...
    <div id="mainLayout" class="easyui-layout" data-options="fit:true, border:false">
        <div data-options="region:'north',border:false, collapsedSize:0" style="height:50px;">
            <div class="head">
                <table>
                    <tr>
                        <td width="50%" style="font-size: 14px;">cochainapi管理平台</td>
        ...
        <div data-options="region:'center', border:false">
            <div id="mainTabs" style="height:250px">
                <div title="首页" id="mainDiv" data-options="iconCls:'glyphicon-home',border:false">
                    <%@ include file="financial/maininfo/main.jsp"%>
                </div>
            </div>
        </div>
    </div>
