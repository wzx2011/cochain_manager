        ...
        <table  class="grid">
            <tr>
                ...
                <td>
                    ...
                    <input name="name" type="text" placeholder="请输入资源名称" value="${resource.name}" class="easyui-textbox span2" data-options="required:true" >
                </td>
                <td>资源类型</td>
                <td>
            ...
            <tr>
                <td>资源路径</td>
                <td><input name="url" type="text" value="${resource.url}" placeholder="请输入资源路径" class="easyui-textbox span2" ></td>
                <td>打开方式</td>
                <td>
