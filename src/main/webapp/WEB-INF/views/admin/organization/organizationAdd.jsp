...
<div style="padding: 3px;">
    <form id="organizationAddForm" method="post">
        <table class="grid">
            <tr>
                <td>编号</td>
                <td><input name="code" type="text" placeholder="请输入部门编号" class="easyui-textbox" data-options="required:true" ></td>
                <td>部门名称</td>
                <td><input name="name" type="text" placeholder="请输入部门名称" class="easyui-textbox" data-options="required:true" ></td>
            ...
            <tr>
                <td>地址</td>
                <td colspan="3"><input name="address" class="easyui-textbox" style="width: 300px;"/></td>
            </tr>
            <tr>
                <td>上级部门</td>
