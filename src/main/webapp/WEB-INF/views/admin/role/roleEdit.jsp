        ...
        <form id="roleEditForm" method="post">
            <table class="grid">
                <tr>
                    ...
                    <input name="name" type="text" placeholder="请输入角色名称" class="easyui-textbox" data-options="required:true" value="${role.name}"></td>
                </tr>
                <tr>
                    <td>排序</td>
               ...
               <c:if test="${role.roleType !=0}">
                   <tr>
                       <td>角色类型</td>
                       <td >
                           <select name="roleType" id="roleTypeEdit" value="${role.roleType}" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
                           </select>
                       </td>
                   </tr>
               </c:if>
