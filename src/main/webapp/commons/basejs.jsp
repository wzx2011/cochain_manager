...
<link rel="stylesheet" type="text/css" href="${staticPath }/static/ueditor/third-party/webuploader/webuploader.css">
<%-- [my97日期时间控件] --%>
...
<script type="text/javascript" src="${staticPath }/static/js/jquery-easyui/jquery.easyui.extend.js"></script>
<script type="text/javascript" src="${staticPath }/static/js/common.js"></script>
<script type="text/javascript" src="${staticPath }/static/js/jquery-easyui/jquery.easyui.datagrid-detailview.js"></script>
<script type="text/javascript" src="${staticPath }/static/js/jquery-easyui/jquery.easyui-lang-cn.js"></script>

<script type="text/javascript" src="${staticPath }/static/ueditor/third-party/webuploader/webuploader.js"></script>
